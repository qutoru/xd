...
# Execution ids of closed trades already announced (WIN/LOSE) to the owner, so the
# outcome reporter never double-sends across listener ticks or process restarts.
TELEGRAM_OUTCOMES_PATH: Path = DATA_DIR / "notified_outcomes.json"
